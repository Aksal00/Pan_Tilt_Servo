...
#define PWM_RESOLUTION 8    // Resolution in bits
#define PWM_DUTY_CYCLE 128  // Duty cycle (0-255 for 8-bit resolution)
...
void setUpPinModes()
{
  ...
  //Set up flash light
  // Initialize the pin with the new LEDC API
  ledcAttach(LIGHT_PIN, PWM_FREQUENCY, PWM_RESOLUTION);
  
  // Set the initial duty cycle
  ledcWrite(LIGHT_PIN, PWM_DUTY_CYCLE);
}
